...
pub enum CliError {
    ...
    #[error("Account {1} has insufficient funds for fee ({0} N1024)")]
    InsufficientFundsForFee(String, Pubkey),
    #[error("Account {1} has insufficient funds for spend ({0} N1024)")]
    InsufficientFundsForSpend(String, Pubkey),
    #[error("Account {2} has insufficient funds for spend ({0} N1024) + fee ({1} N1024)")]
...
mod tests {
    ...
    fn test_cli_process_command() {
        ...
        assert_eq!(process_command(&config).unwrap(), "0.00000005 N1024");
