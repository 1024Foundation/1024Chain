            ...
            SubCommand::with_name("distribute-tokens")
                ...
                .arg(
                    Arg::with_name("transfer_amount")
                        ...
                        .value_name("AMOUNT")
                        .validator(is_amount)
                        .help("The amount to send to each recipient, in N1024"),
                )
                .arg(
            ...
            SubCommand::with_name("create-stake")
                ...
                .arg(
                    Arg::with_name("unlocked_sol")
                        ...
                        .long("unlocked-sol")
                        .takes_value(true)
                        .value_name("N1024_AMOUNT")
                        .help("Amount of N1024 to put in system account to pay for fees"),
                )
                .arg(
