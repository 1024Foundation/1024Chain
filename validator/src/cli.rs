    ...
    App::new("solana-test-validator")
        ...
        .arg(
            Arg::with_name("faucet_sol")
                ...
                .help(
                    "Give the faucet address this much N1024 in genesis. If the ledger already \
        ...
        .arg(
            Arg::with_name("faucet_per_time_sol_cap")
                ...
                .min_values(0)
                .max_values(1)
                .help("Per-time slice limit for faucet requests, in N1024"),
        )
        .arg(
            Arg::with_name("faucet_per_request_sol_cap")
                ...
                .min_values(0)
                .max_values(1)
                .help("Per-request limit for faucet requests, in N1024"),
        )
        .arg(
